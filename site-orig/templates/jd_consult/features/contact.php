...
class Helix3FeatureContact {
	...
	public function renderFeature() {
		...
		if($this->helix3->getParam('enable_contactinfo')) {
			...
			if($this->helix3->getParam('contact_email')) $output .= '<li class="sp-contact-email"><i class="fa fa-envelope-o"></i> '.JText::_('COM_SPPB_EMAILUS').' <a href="mailto:'. $this->helix3->getParam('contact_email') .'">' . $this->helix3->getParam('contact_email') . '</a></li>';
